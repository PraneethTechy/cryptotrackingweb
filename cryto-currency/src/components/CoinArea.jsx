    ...
    <div className='min-h-screen bg-gradient-to-br from-gray-900 via-gray-900/95 to-gray-900/90 text-white px-4 sm:px-[5%] py-6 md:py-10 relative z-0'>
      ...
      <div className='text-center mb-8 md:mb-12 space-y-4 group relative '>
        ...
        <p className='text-gray-300/80 max-w-xl mx-auto text-sm sm:text-base md:text-lg leading-relaxed mt-4'>
          Track real-time crypto metrics with our advanced market intelligence and
      ...
      <div className='hidden md:grid grid-cols-5 gap-4 text-sm py-4 px-4 mb-2 bg-gray-800/40 backdrop-blur-lg rounded-xl border border-gray-500/20'>
      ...
      {isCurrencyDropdownOpen && (
        <div className='relative bg-gray-800/95 backdrop-blur-xl rounded-lg border border-emerald-500/20 shadow-2xl z-50'>
          {["usd", "eur", "inr"].map((code) => (
            <div key={code} className='px-4 py-3 hover:bg-emerald-600/30 transition-colors cursor-pointer flex items-center gap-2 ' onClick={() => handleCurrencySelect(code)}>
          ...
          <Link to={`/crypto/${item.id} `} key={item.id} className='block p-4 bg-gray-800/30 backdrop-blur-md hover:bg-gray-700/40 rounded-xl border border-emerald-500/10 hover:border-cyan-500/30 transition-all duration-300 group'>
            ...
            <div className='md:hidden space-y-3'>
              <div className='flex items-center justify-between'>
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    ...
                    <p className='text-xs sm:text-sm text-gray-400/80 mt-0.5'>
              ...
              <div className='flex items-center justify-between pt-2 border-t border-emerald-500/10'>
                <div className={`flex items-center gap-1 text-sm sm:text-base
                  ...
                  <span> {item.price_change_percentage_24h > 0 ? '&#9650' : '&#9660'} </span>
                ...
                <div className='text-right'>
                  ...
                  <p className='text-xs sm:text-sm text-gray-400/60 mt-0.5'>
            ...
            <div className='hidden md:grid grid-cols-5 gap-4 items-center'>
              ...
              <div className={`text-center px-2 py-1 rounded-full text-sm lg:text-base'
                ${item.price_change_percentage_24h > 0 ? 'bg-emerald-500/20 text-emerald-400' : 'bg-red-500/20 text-red-400'}`}>
              ...
              <div className='text-right'>
                  ...
                  <p className='text-xs lg:text-sm text-gray-400/60 mt-0.5'>
                    Vol : {currentCurrency.symbol}{item.total_volume.toLocaleString()}
                  </p>
                </div>
