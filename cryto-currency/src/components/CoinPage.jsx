...
const CoinPage = () => {
  ...
  const requestOptions = {
    method: 'GET',
    headers: { accept: 'application/json', 'x-cg-demo-api-key': 'CG-dk7hqA7yGLMtZcWMRwx7bu23' }
  };
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const chartRes = await fetch(`https://api.coingecko.com/api/v3/coins/${cryptoId}/market_chart?vs_currency=${currentCurrency.name}&days=${period}&interval=daily`, requestOptions);
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-900 via-gray-900/95 to-gray-900/90 text-white px-4 sm:px-[5%] md:px-[8%] py-6'>
      ...
      <div className='mb-6 bg-gray-800/30 backdrop-blur-md p-4 rounded-xl border border-emerald-500/20'>
        ...
        <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 gap-2'>
          ...
          <div className='relative group'>
            ...
            <div className='absolute -inset-0.5 bg-gradient-to-r from-emerald-600/20 to-cyan-500/20 
            rounded-lg blur opacity-30 group-hover:opacity-50 transition duration-300 -z-10'/>
      ...
      <div className='space-y-3 md:hidden'>
        ...
        <div className='bg-gray-800/30 backdrop-blur-md p-4 rounded-lg border border-emerald-500/20'>
          <div className='flex justify-between items-center'>
            <span className='test-sm text-cyan-400/80'> Market Cap </span>
            <span className='text-lg font-bold text-emerald-400'>
              {currentCurrency.symbol}
        ...
        <div className='bg-gray-800/30 backdrop-blur-md p-4 rounded-lg border border-emerald-500/20'>
          <div className='space-y-3'>
            <div className='flex justify-between items-center'>
              <span className='test-sm text-cyan-400/80 p-2'> 24H High </span>
            ...
            <div className='flex justify-between items-center'>
              <span className='test-sm text-cyan-400/80 p-2'> 24H Low </span>
