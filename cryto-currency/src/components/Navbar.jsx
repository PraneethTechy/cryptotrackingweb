       ...
       <form onSubmit={searchHandler} className='order-3 w-full md:order-2  md:w-auto flex-1 max-w-2xl mx-0 md:mx-4 relative'>
         <div className='relative group' >
          ...
          <div className='relative flex items-center '>
            <input type="text" placeholder='search Crypto... ' value={input} onChange={inputHandler} required className='w-full max-w-[calc(100%-50px)] px-6 py-3 bg-gray-800/60 border border-gray-600/30 rounded-full focus:outline-none focus:ring-2 focus:ring-emerald-500/50 placeholder-gray-400 text-gray-200 backdrop-blur-sm'/>
